(* OASIS_START *)
(* DO NOT EDIT (digest: 2d39d98440b638694ecb8e555207409f) *)
...
let package_default =
  {
     MyOCamlbuildBase.lib_ocaml = [("src/ocsforge", ["src"])];
     lib_c = [("ocsforge", "src/", [])];
     flags =
       [
          (["oasis_library_ocsforge_ccopt"; "compile"],
            [
               (OASISExpr.EBool true,
                 S
                   [
                      A "-ccopt";
                      A "-I/usr/include/subversion-1";
                      A "-ccopt";
                      A "-I/usr/include/apr-1.0";
                      A "-ccopt";
                      A "-D_LARGEFILE64_SOURCE"
                   ])
            ]);
          (["oasis_library_ocsforge_cclib"; "link"],
            [(OASISExpr.EBool true, S [A "-cclib"; A "-lsvn_client-1"])]);
          (["oasis_library_ocsforge_cclib"; "ocamlmklib"; "c"],
            [(OASISExpr.EBool true, S [A "-lsvn_client-1"])])
       ];
     }
  ;;
