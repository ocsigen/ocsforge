...
val get_task_by_id :
  ...
  ?with_deleted:bool ->
  Ocsi_sql.db_t -> Ocsforge_types.task_info Lwt.t
...
val get_tasks_by_parent :
  parent:Ocsforge_types.task ->
  ?with_deleted:bool ->
  Ocsi_sql.db_t -> Ocsforge_types.task_info list Lwt.t
...
val get_area_info_for_task :
  task_id:Ocsforge_types.task ->
  Ocsi_sql.db_t -> Ocsforge_types.right_area_info Lwt.t
...
val change_tree_marks :
  task_id:Ocsforge_types.task ->
  parent_id:Ocsforge_types.task -> Ocsi_sql.db_t -> unit Lwt.t
...
val get_kinds_for_area :
  area_id:Ocsforge_types.right_area ->
  Ocsi_sql.db_t -> string list Lwt.t
...
val get_separators :
  ...
  Ocsi_sql.db_t -> Ocsforge_types.separator_info list Lwt.t
